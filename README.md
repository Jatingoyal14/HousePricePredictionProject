...
This project is licensed under the [MIT License](https://github.com/Jatingoyal14/HousePricePredictionProject?tab=MIT-1-ov-file#). See the LICENSE file for details.
